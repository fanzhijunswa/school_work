...
.channel
    ...
    article-wrapper(:gdywArr="bmdtArr" articleName="测试")
...
export default {
  ...
  methods: {
    ...
    getXyfc () {
      return new Promise((resolve, reject) => {
        this.$http.get('/information/xyfc', { params: { start: 1, page: 20 } }).then(resp => {
          this.xyfcArr = _.get(resp, 'data.data', [])
          console.log(this.xyfcArr[0])
